...
use Laminas\Barcode\Barcode\Exception\InvalidArgumentException as BarcodeInvalidArgumentException;
 ...
 */
class BarcodeValidationException extends BarcodeInvalidArgumentException
{
}
